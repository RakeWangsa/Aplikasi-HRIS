<aside id="sidebar" class="sidebar">
   <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
         <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#"> <i class='bx bxs-report'></i><span>Penilaian</span><i class="bi bi-chevron-down ms-auto"></i> </a>
         <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li> <a class="nav-link collapsed {{ ($active === "okr_admin") ? 'active' : '' }}" href="/admin/okr"> <i class="bi bi-circle"></i><span>OKR</span> </a></li>
            <li> <a class="nav-link collapsed {{ ($active === "kpi_admin") ? 'active' : '' }}" href="/admin/kpi"> <i class="bi bi-circle"></i><span>KPI</span> </a></li>
         </ul>
      </li>
      @endif
      @endauth
