<aside id="sidebar" class="sidebar">
   <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <a class="nav-link collapsed {{ ($active === "profile_executive") ? 'active' : '' }}" href="/daftar/karyawan"> <i class='bx bxs-user-circle'></i></i><span>Daftar Karyawan</span> </a>
      ...
      <a class="nav-link collapsed {{ ($active === "profile_admin") ? 'active' : '' }}" href="/admin/profiles"> <i class='bx bxs-user-circle'></i></i><span>Profiles</span> </a>
