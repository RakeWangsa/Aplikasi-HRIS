...
Route::group(['middleware' => ['auth', 'ceklevel:admin']], function () {
    ...
    route::get('/admin/kpi/{jenis}/{filter}', [PenilaianController::class, 'kpi_admin_filter'])->name('kpi_admin_filter')->middleware('auth');
    ...
    route::get('/admin/kpi/hasilKPI/{divisi}', [PenilaianController::class, 'hasil_KPI'])->name('hasilKPI')->middleware('auth');
